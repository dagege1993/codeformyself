    ...
    o(a.prototype, {
            ...
            createCanvas: function (t) {
                ...
                for (var d = 0; i > d; d++) for (var m = 0; i > m; m++) {
                        ...
                        o.fillStyle = t.modules[d][m] ? b : e.background,
                        o.fillRect(Math.round(m * c), Math.round(d * f), p, v)
                    }
            ...
            createTable: function (t) {
                ...
                if (n.push("</table>"), e.image) {
                        ...
                        n.push("<img src='" + e.image + "'\n                        width='" + e.imageSize + "'\n                        height='" + e.imageSize + "'\n                        style='position:absolute;left:" + c + "px; top:" + f + "px;'>"),
                        n.push("</div>")
                    }
                var d = document.createElement("span");
                return d.innerHTML = n.join(""),
                d.firstChild
            },
            createSVG: function (t) {
                ...
                for (var n = 0; r > n; n++) for (var u = 0; r > u; u++) {
                        ...
                        t.modules[n][u] ? a.setAttribute("fill", l) : a.setAttribute("fill", e.background),
                        i.appendChild(a)
                    }
                if (e.image) {
                        var h = document.createElementNS("http://www.w3.org/2000/svg", "image");
                        h.setAttributeNS("http://www.w3.org/1999/xlink", "href", e.image),
                        h.setAttribute("x", ((r - e.imageSize * o) / 2).toFixed(2)),
                        h.setAttribute("y", ((r - e.imageSize * o) / 2).toFixed(2)),
                        h.setAttribute("width", e.imageSize * o),
                        h.setAttribute("height", e.imageSize * o),
                        i.appendChild(h)
                    }
                return i
            }
    ...
    i.prototype = {
        ...
        createBytes: function (t) {
            ...
            for (var f = new Array(s.length), d = new Array(s.length), m = 0; m < s.length; m++) {
                ...
                e += p;
                var b = l.getErrorCorrectPolynomial(v),
    ...
    for (var u = [1, 0, 3, 2], a = {
        ...
        getLostPoint: function (t) {
            for (var e = t.getModuleCount(), r = 0, o = 0, i = 0; e > i; i++) for (var n = 0, s = t.modules[i][0], u = 0; e > u; u++) {
                ...
                s ^ a ? n++ : (s = a, n >= 5 && (r += 3 + n - 5), n = 1),
                a && o++
            }
            for (var u = 0; e > u; u++) for (var n = 0, s = t.modules[0][u], i = 0; e > i; i++) {
                var a = t.modules[i][u];
                e - 6 > i && a && !t.modules[i + 1][u] && t.modules[i + 2][u] && t.modules[i + 3][u] && t.modules[i + 4][u] && !t.modules[i + 5][u] && t.modules[i + 6][u] && (e - 10 > i ? t.modules[i + 7][u] && t.modules[i + 8][u] && t.modules[i + 9][u] && t.modules[i + 10][u] && (r += 40) : i > 3 && t.modules[i - 1][u] && t.modules[i - 2][u] && t.modules[i - 3][u] && t.modules[i - 4][u] && (r += 40)),
                s ^ a ? n++ : (s = a, n >= 5 && (r += 3 + n - 5), n = 1)
            }
