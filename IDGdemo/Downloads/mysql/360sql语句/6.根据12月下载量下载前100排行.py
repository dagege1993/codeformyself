...
select app_keys,downs,(
select downs from ANDROID_SAFE_APP_DAILY where dt_type='周' and stat_dt='%s' and app_keys=a.app_keys) as f_downs
...
) and stat_dt>='2018-01-01' and stat_dt<'2018-12-31' ) a )a )a left join ANDROID_SAFE_APP b on (a.app_keys=b.app_keys)
